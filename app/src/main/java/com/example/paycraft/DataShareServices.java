...
public class DataShareServices {
    ...
    private static final UUID MY_UUID_SECURE = UUID
            .fromString("fa87c0d0-afac-11de-8a39-0800200c9a67");
    private static final UUID MY_UUID_INSECURE = UUID
            .fromString("8ce255c0-200a-11e0-ac64-0800200c9a67");
    // Member fields
    ...
    public DataShareServices(Context context, Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (state != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (DataShareServices.this) {
                        switch (state) {
                            case STATE_LISTEN:
